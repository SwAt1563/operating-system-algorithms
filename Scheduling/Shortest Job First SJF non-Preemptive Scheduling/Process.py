class Process:
    def __init__(self, p_id, burst_time, arrival_time, priority):
        self.p_id = p_id
        self.burst_time = burst_time  # Progress time
        self.arrival_time = arrival_time  # When the process arrived the ready queue
        self.priority = priority  # PROCESS WITH LOWER PRIORITY NUMBER MEAN IT HAS HIGHEST PRIORITY
    ...
    def to_string(self):
        return 'id: {}, burst_time: {}, arrival_time: {}, priority: {}, state: {}, achieved_work: {}, ' \
